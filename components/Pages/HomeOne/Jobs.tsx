...
import jobsImage from "@/public/images/jobs/Starry-Night-Reflection.jpeg";

export default function Jobs() {
  return (
    <section className="bg-nu70 lg:py-20 md:py-16 py-[60px]" id="jobs">
            ...
            <Swiper
              ...
              <SwiperSlide className="swiper-slide bg-nu10 sm:px-4 px-2 sm:py-4 py-2">
                ...
                <div className="sm:mt-6 mt-4 w-full h-full">
                  ...
                  <p className="text-nu30 sm:pb-6 pb-4 sm:text-[18px] text-[14px] font-medium">
                    We provide innovative designs that combine aesthetics with
                    function your specific needs.
                  </p>
                  <div>
                    <Link
                       href="job-details"
          ...
          {/* <div
            ...
            <div className="flex justify-center items-center gap-4">
              <button
                ...
                <span className="px-3 py-2 flex items-center text-nu30">
