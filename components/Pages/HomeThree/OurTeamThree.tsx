...
export default function OurTeamThree() {
  return (
        ...
        <div>
          ...
          <div className="swiper mySwipery mt-14">
            <Swiper
              ...
              {/* <!-- card 1 --> */}
              <SwiperSlide className="swiper-slide sm:px-4 px-2">
                <div className="img-box relative">
                  ...
                  <div className="absolute bottom-[20px] left-1/2 -translate-x-1/2 w-[90%] bg-nu70 m-auto xl:px-6 lg:px-2 px-6 xl:py-3 lg:py-1 py-3">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="btn">
                        <span className="show-btn px-3 py-2 flex items-center cursor-pointer">
                          <i className="xl:text-[26px] text-[18px] ph-bold ph-share-network"></i>
                        </span>
                      </div>
                    </div>
                  </div>
