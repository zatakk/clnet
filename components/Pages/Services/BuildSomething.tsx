...
export default function BuildSomething() {
  return (
    <div className="great-together-section pt-12 md:pt-20 pb-[140px]">
                ...
                <form>
                  ...
                  <div className="flex items-center gap-2 bg-nu70">
                    <span className="pl-4 flex items-center">
                      <i className="text-nu30 ph ph-check-fat"></i>
                    </span>
                    <select className="w-full sm:h-[68px] h-[50px] bg-nu70 !border-none outline-none flex items-center !bg-nu70 !text-nu30">
                      <option
